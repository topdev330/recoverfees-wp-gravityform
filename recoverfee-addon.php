...
class GFRecoverFeesAddOn extends GFAddOn {

	protected $_version = GF_SIMPLE_ADDON_VERSION;
	protected $_min_gravityforms_version = '1.9';
	protected $_slug = 'recoverFees';
	protected $_path = 'recoverFees/recoverfee-addon.php';
	 ...
	 *
	 * @return GFRecoverFeesAddOn
	 */
	public static function get_instance() {
		if ( self::$_instance == null ) {
			self::$_instance = new GFRecoverFeesAddOn();
		}
	...
	public function scripts() {
		$scripts = array(
			...
			array(
				'handle'   => 'recover_fees_handle',
				'src'      => $this->get_base_url() . "/js/custom-scripts.js",
				'version'  => $this->_version,
				'deps'     => array( 'jquery' ),
